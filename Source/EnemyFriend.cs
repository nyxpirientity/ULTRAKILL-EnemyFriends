...
{
    public static class EnemyFriendIdentifierEnemyComponentsExtension
    {
        public static EnemyFriendIdentifier GetEnemyFriendIdentifier(this EnemyComponents enemy)
        {
            return enemy.GetMonoByIndex<EnemyFriendIdentifier>(EnemyFriendIdentifier.MonoRegistrarIdx);
        }
    }
    ...
    public class EnemyFriendIdentifier : EnemyModifier
    {
        ...
        {
            if (Eid.enemyType == EnemyType.Idol || !IsLeader && NyxLib.Cheats.IsCheatEnabled(Cheats.GiveEnemiesFriends))
            {
                IdolFindRightTarget();
            }
        }
        ...
        protected void Awake()
        {
            ...
            Eid = Ead.Eid;
            IsLeader = Ead.IsEnemyCompInitializer;
        }
        ...
        protected void Start()
        {
            ...
            if (NyxLib.Cheats.IsCheatEnabled(Cheats.GiveEnemiesFriends) && !Ead.UniquelySolo && !ExcludedFromFriends)
            {
        ...
        private void IdolFindRightTarget()
        {
            ...
            var leaderTargetFriends = leaderTargetEadd.GetEnemyFriendIdentifier().Friends;
        ...
        private EnemyFriendIdentifier SpawnFriend(Vector3 offset, int idx)
        {
            ...
            friend.SetActive(true);
            friendEadd.GetEnemyFriendIdentifier().Leader = this;
            friendEadd.PrefabStore.StorePrefab(force: true);
            friendEadd.GetEnemyFriendIdentifier().FriendIdx = idx;

            return friendEadd.GetEnemyFriendIdentifier();
        }

        internal static void Initialize()
        {
            MonoRegistrarIdx = EnemyComponents.MonoRegistrar.Register<EnemyFriendIdentifier>();
        }
    }
}